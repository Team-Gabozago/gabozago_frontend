...
export type CombineElementProps<T extends React.ElementType, K = unknown> =
...
// 출처 : https://evan-moon.github.io/2020/11/28/making-your-components-extensible-with-typescript/
